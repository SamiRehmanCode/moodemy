      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Manage the welcome message on home screen</p>
          </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>This message is displayed when users open the app home screen</CardDescription>
          </CardHeader>
